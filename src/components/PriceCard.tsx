export const PriceCard = () => {
    return (
        <div className="w-full bg-[#8ECAE6] p-10 rounded-xl shadow-xl hover:scale-105 transition duration-300 group z-30">
            ...
            <button
                className="bg-[#219EBC] text-white transition-all rounded-lg text-lg p-2 w-full group-hover:bg-[#023047]"
            >Choose Plan</button
            >
        </div>
    )
